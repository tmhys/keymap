...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT(\
		  ...
		  M_HNZN_TGL, KC_A,    KC_S,    KC_D,    KC_F,  KC_G,   KC_DEL,  						KC_BSPC, KC_H,   KC_J,  	 KC_K,    KC_L,    KC_SCLN, KC_QUOT, \
		  KC_LSFT,    KC_Z,    KC_X,    KC_C,    KC_V,  KC_B,   KC_TAB ,  						KC_SPC, KC_N,   KC_M,  	 KC_COMM, KC_DOT,  KC_UP,   KC_NUBS, \
		  KC_LCTL,    KC_LGUI, KC_LALT, KC_LCTL, 		LOWER,  KC_ESC,	KC_SPC,		   KC_RSFT, KC_ENT,  RAISE,  KC_SLSH, 	 		  KC_LEFT, KC_DOWN, KC_RGHT	 \
		  ),
